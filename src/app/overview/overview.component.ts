...
export class OverviewComponent {
  constructor(
    private dataService: HeroService
  ) { }
  ...
  themeChange(myevent: any) {
    console.log(myevent);
    console.log(myevent.checked);
  }

  products = this.dataService.data; //[6]
  ...
  trackByFunction(index: number, product: any) {
    return product.id;
  }
